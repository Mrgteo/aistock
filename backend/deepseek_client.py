...
"""
        ...
        if quarterly_data and quarterly_data.get('data_success'):
            # 使用格式化的季报数据
            from backend.services.quarterly_report_data import QuarterlyReportDataFetcher
...
"""
    ...
    def fund_flow_analysis(self, stock_info: Dict, indicators: Dict, fund_flow_data: Dict = None) -> str:
        ...
        if fund_flow_data and fund_flow_data.get('data_success'):
            # 使用格式化的资金流向数据
            from backend.services.fund_flow_akshare import FundFlowAkshareDataFetcher
